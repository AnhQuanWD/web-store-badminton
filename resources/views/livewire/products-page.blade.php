<div class="w-full mx-auto">
    <div class="rounded" style="margin-bottom: 20px">
        <img class="rounded" src="/images/banner-product.jpeg" alt="">
    </div>

    <div class="w-full max-w-[85rem] sm:px-6 lg:px-8 mx-auto">
        <div id="breadcrumbs">
            ...
            <div class="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
                <div class="flex flex-wrap mb-24 -mx-3">
                            ...
                            <ul>
                                <li class="mb-4">
                                    <label for="featured" class="flex items-center dark:text-gray-300">
                                        <input wire:model.live="featured" type="checkbox" value="1" id="featured" class="w-4 h-4 mr-2">
                                        <span class="text-lg dark:text-gray-400">Featured Products</span>
                                    </label>
                                </li>
                                <li class="mb-4">
                                    <label for="on_sale" class="flex items-center dark:text-gray-300">
                                        <input wire:model.live="on_sale" type="checkbox" value="1" id="on_sale" class="w-4 h-4 mr-2">
                    ...
                    <div class="w-full px-3 lg:w-4/4">
                                    ...
                                    <div class="border border-gray-300 dark:border-gray-700 rounded">
                                        <div class="relative bg-gray-200">
                                            <a href="/products/{{ $product->slug }}" class="">
                                                <img src="{{ url('storage', $product->images[0]) }}"
                                                    alt="{{ $product->name }}" class="object-cover w-full h-56 mx-auto rounded">
                                            </a>
                                        </div>
                                        <div class="p-3 ">
                                        ...
                                        <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                                            ...
                                            <a wire:click.prevent='addToCart({{ $product->id }})' href="#"
                                                ...
                                                </svg><span wire:laoding.remove wire:target='addToCart({{ $product->id }})'>Add to Cart</span> <span wire:loading wire:target='addToCart({{ $product->id }})'>Adding...</span>
                                            </a>
                        ...
                        <!-- pagination start -->
                        <div id="pagination_wrapper" class="flex justify-end mt-6">
                            {{ $products->links() }}
